...
class AnalysisThread(QThread):
    ...
    def _execute(self) -> None:
        ...
        if metrics.get("spatial"):
            ...
            localmax_footprint_mult = s.get("localmax_footprint_mult", SECTION8_LOCALMAX_FOOTPRINT_MULT)
            localmax_prominence_percentile = s.get("localmax_prominence_percentile", SECTION8_LOCALMAX_PROMINENCE_PERCENTILE)
            localmax_top_percent = s.get("localmax_top_percent", SECTION8_LOCALMAX_TOP_PERCENT)
